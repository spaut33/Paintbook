"""
Django settings for modelpaints project.
...
INSTALLED_APPS = [
    ...
    #  Django debug toolbar TODO: make it visible on serializer viewset (httpresponse)
    'debug_toolbar',
    'social_django',
    'tailwind',
    'theme',
...
WSGI_APPLICATION = 'modelpaints.wsgi.application'
...
# All keys/secrets are in .env file
